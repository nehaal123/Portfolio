...
if(isset($xml->story->mcq_text)){
    //Here make arrays
    //$text_task = array();
    foreach($xml->story->mcq_text as $parse):
...
if(isset($xml->story->mcq_listen)){
    foreach($xml->story->mcq_listen as $parse):
...
if(isset($xml->story->mcq_match)){
    foreach($xml->story->mcq_match as $parse):
        array_push($opt1, $parse->opt1);
        array_push($opt2, $parse->opt2);
        array_push($opt3, $parse->opt3);
...
if(isset($xml->story->mcq_order)){
    foreach($xml->story->mcq_order as $parse):
...
if(isset($xml->story->mcq_visual)){
    foreach($xml->story->mcq_visual as $parse):
